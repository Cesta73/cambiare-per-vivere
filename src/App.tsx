...
function DesktopSidebar() {
  ...
  return (
    <aside className="desktop-sidebar hidden lg:flex sticky top-6 h-[calc(100dvh-3rem)] flex-col overflow-hidden">
      <div className="p-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          <BrandMark className="w-12 h-12 text-mineral" />
          ...
          return (
            ...
            >
              <span className={`w-10 h-10 flex items-center justify-center flex-shrink-0 ${
                active ? 'bg-amber-400 text-petrol-900' : 'bg-white/7 text-sage-200'
              }`}>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="border border-white/10 p-3">
          ...
          <p className="text-[11px] leading-relaxed text-sage-300 mt-2">Core connesso · dati sincronizzati</p>
        </div>
      </div>
    </aside>
  );
  ...
  return (
    <aside className="desktop-right-rail hidden 2xl:block sticky top-6 h-[calc(100dvh-3rem)] overflow-y-auto space-y-4">
      <button
        ...
        className="jarvis-rail-button w-full text-left transition-all active:scale-99"
      ...
      <section className="card border-sage-200">
        <div className="flex items-center gap-2 mb-3">
          <HeartPulse size={18} className="text-sage-700" />
          <h2 className="font-semibold text-warm-gray-800">Presenza quotidiana</h2>
        </div>
        <div className="space-y-3 text-sm">
          <button onClick={() => setActiveTab('raw-data')} className="w-full text-left border border-sage-100 p-3 hover:bg-white transition-colors">
          ...
          <button onClick={() => setActiveTab('cammino')} className="w-full text-left border border-sage-100 p-3 hover:bg-white transition-colors">
          ...
          <button onClick={() => setActiveTab('dharma')} className="w-full text-left border border-sage-100 p-3 hover:bg-white transition-colors">
